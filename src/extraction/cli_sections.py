"""CLI for extracting document sections from PAD markdown files."""
...
def main():
    """CLI entry point for extracting document sections."""
    parser = argparse.ArgumentParser(
        description="Extract document sections from PAD markdown files using OpenAI API"
    )
    parser.add_argument(
        "--markdown",
        type=str,
    ...
    # Run extraction
    print(f"Extracting document sections from: {markdown_dir}")
    if args.markdown:
